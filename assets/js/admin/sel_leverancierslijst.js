...
$(function() {
    ...
    // $("#m_statiegeld_eenheid, #m_aantal_omdozen, #m_statiegeld_eenheid2, #m_losse_geteld, #m_lege_geteld").on("change", function(){
    //     var totaal = 0;
    //     tottal = $("#m_aantal_omdozen").val() * $("#m_statiegeld_eenheid").val() + $("#m_aantal_omdozen").val() * $("#m_inhoud_verpakking").val() * $("#m_statiegeld_eenheid2").val() + (parseFloat($("#m_losse_geteld").val()) + parseFloat($("#m_lege_geteld").val())) * $("#m_statiegeld_eenheid2").val();
    //     $("#m_total_statiegeld").val(parseFloat(tottal).toFixed(4));

    //     var waarde1 = 0, waarde2 = 0;
    //     waarde1 = $("#m_aantal_omdozen").val() * $("#m_prijs_omdoos").val() + (parseFloat($("#m_losse_geteld").val()) + parseFloat($("#m_lege_geteld").val())) * $("#m_statiegeld_eenheid2").val();
    //     $("#m_waarde_voorraad1").val(parseFloat(waarde1).toFixed(4));

    //     waarde2 = tottal + waarde1;
    //     $("#m_waarde_voorraad2").val(parseFloat(waarde2).toFixed(4));
...
var save_stock = function(){
    ...
    // let waarde_voorraad = parseFloat(($("#m_statiegeld_eenheid").val()?$("#m_statiegeld_eenheid").val():0)) * parseFloat(($("#m_losse_geteld").val()?$("#m_losse_geteld").val():0));
    ...
    $.post(SITE_URL + 'voorraadtelling/save_copy_stock', 
        {
            ...
            total_voorraad_waarde: parseFloat($("#m_total_statiegeld").val()) + waarde_voorraad,
